            ...
            if (inputEnabled)
            {
                switch (inputType)
                {
                    case InputType.Tank:
                        {
                            // Calculate speed.
                            var targetSpeed = Input.GetAxisRaw("leftstick1vertical");
                            ...
                            var targetRotateSpeed = Input.GetAxisRaw("leftstick1horizontal");
                    ...
                    case InputType.Direct:
                        {
                            ...
                            var targetSpeed = right * Input.GetAxisRaw("leftstick1horizontal");
                            targetSpeed += forward * Input.GetAxisRaw("leftstick1vertical");

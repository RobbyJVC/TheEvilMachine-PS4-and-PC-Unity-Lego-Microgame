    ...
    public class OptionsMenuManager : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            QualitySettings.shadows = ShadowQuality.All;
             m_ShadowsToggle.SetIsOnWithoutNotify(QualitySettings.shadows != ShadowQuality.Disable); //this enables shadows off the bat!
          
            m_ShadowsToggle.SetIsOnWithoutNotify(true); // doesn't really set the shadows! just makes the "Checks" off the button
